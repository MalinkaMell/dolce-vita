  ...
  return (
    ...
    <MDBCol md="3" xs="12" className="mb-3 pb-3">
      <MDBCard className="h-100">
        <div className='rounded-top italian-red-bg lighten-3 text-center pt-3'>
        ...
        <MDBCardBody>
          <MDBCardTitle tag="h5" className="italian-green-color">{props.review.user.name}</MDBCardTitle>
          <StarRatings
        ...
        <div className='rounded-bottom italian-white-bg text-center pt-3'>
          <ul className="list-unstyled list-inline d-flex justify-content-between align-content-center">
            <li className='list-inline-item pr-2 white-text align-self-center'>
              <a href={props.review.url} className="italian-red-color font-weight-bold pl-4">Dolce Vita Gelato</a>
            </li>
            <li className='list-inline-item pr-2 white-text'>
